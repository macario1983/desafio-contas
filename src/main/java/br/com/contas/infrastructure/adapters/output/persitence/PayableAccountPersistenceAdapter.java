...
public class PayableAccountPersistenceAdapter implements PayableAccountOutputPort {
    ...
    public PayableAccountResponse createPayableAccount(@Valid PayableAccount payableAccount) {
        ...
        try {
            ...
            this.logger.error("Erro ao persistir o payable account: {}", payableAccount, ex);
            throw ex;
        }
    }
    ...
    public PayableAccountResponse updatePayableAccount(UUID id, PayableAccount payableAccount) {
        ...
        try {
            ...
            this.logger.error("Erro ao alterar o payable account: {}", payableAccount, ex);
            throw ex;
        }
    }
    ...
    public PayableAccountResponse updatePayableAccountStatus(UUID id, Map<String, Object> fields) {
        ...
        try {
            ...
            PayableAccountEntity payableAccountEntity = this.repository.findById(id)
                    .orElseThrow(PayableAccountNotFoundException::new);
    ...
    public void importCSV(MultipartFile file) {
        ...
        try {
            ...
            List<PayableAccountEntity> payableAccountEntities = Arrays.stream(contas)
                    .map(s -> {
